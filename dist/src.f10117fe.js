...
var ApiSync = /** @class */function () {
  ...
  ApiSync.prototype.delete = function (id) {
    axios_1.default.delete("".concat(this.rootUrl, "/").concat(id)).then(function (response) {
      ...
      console.error("Error deleting user_id: ".concat(id, ", this user does not exist."));
    });
  };
  ;
  return ApiSync;
...
exports.User = User;
},{"./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./Events":"src/models/Events.ts","./ApiSync":"src/models/ApiSync.ts","./Collection":"src/models/Collection.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
var UserForm = /*#__PURE__*/function (_View_1$View) {
  function UserForm() {
    ...
    _this.onSetRandomAgeClick = function () {
...
var UserShow = /*#__PURE__*/function (_View_1$View) {
  ...
  return _createClass(UserShow, [{
    key: "template",
    value: function template() {
      return "\n        <div>\n            <h1>User Details</h1>\n            <p>name: ".concat(this.model.getProperty('name'), "</p>\n            <p>age: ").concat(this.model.getProperty('age'), "</p>\n        </div>\n        ");
    }
  }]);
}(View_1.View);
...
// });
// newCollection.fetch();
var user = User_1.User.createUser({
  'id': 1,
  'name': 'Jalapeno',
  'age': 97
});
...
},{"./models/User":"src/models/User.ts","./views/UserEdit":"src/views/UserEdit.ts"}],"../../../../opt/homebrew/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
